...
class xActivityPubObject {
    ...
    copyAddressingProperties(object) {
        if (object.to) this.to = this.to.concat(object.to);
        if (object.cc) this.cc = this.cc.concat(object.cc);
        if (object.bto) this.bto = this.bto.concat(object.bto);
        if (object.bcc) this.bcc = this.bcc.concat(object.bcc);
        if (object.audience) this.audience = this.audience.concat(object.audience);
    }
}
